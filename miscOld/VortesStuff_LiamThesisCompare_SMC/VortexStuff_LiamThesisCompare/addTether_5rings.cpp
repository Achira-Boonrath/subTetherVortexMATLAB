...
void addTether(std::string pathData, VxSmartInterface<Mechanism> mechanism, VxSmartInterface<Part> chaserPart, VxSmartInterface<Part> **partMatrix, VxSmartInterface<Part> winchPart)
{
    ...
    (parameters)[CableSystems::GraphicsICD::kRadiusID].setValue(tetherRadius*10);
...
void addTether(std::string pathData, VxSmartInterface<Mechanism> mechanism, VxSmartInterface<Part> chaserPart, VxSmartInterface<Part> **partMatrix, VxSmartInterface<Part> winchPart, int tetherCounter)
{
	// read constants
	std::stringstream constantsFileName;
	std::ifstream inFile;
	...
	{
		std::cout  << std::endl << "Read " << std::endl;
		sizeRingPartX = readArray("ringsPartX", tetherDataFileName, ringPartX, indexCenterPart, indexLastPart, indexQuarterPart);
		sizeRingPartY = readArray("ringsPartY", tetherDataFileName, ringPartY, indexCenterPart, indexLastPart, indexQuarterPart);
	}
	...
	for (int i=0; i<ringsNb; i++)
	{
		...
		else if (tetherCounter == 1)
		{
			...
			{
				//ringPointNet_1[PointDefinitionContainerID::kPartID].setValue(partMatrix[indexQuarterPart][0].getExtension()); 
		...
		else if (tetherCounter == 2)
		{
			...
			{
				//ringPointNet_1[PointDefinitionContainerID::kPartID].setValue(partMatrix[0][indexQuarterPart].getExtension()); 
				//ringPointNet_1[RingDefinitionContainerID::kRelativePrimaryAxisID].setValue(Vx::VxVector3(0.0, 1.0, 0.0));		
			//}
			//else if (i==3)
			//{
		...
		else if (tetherCounter == 3)
		{
			...
			{
				//ringPointNet_1[PointDefinitionContainerID::kPartID].setValue(partMatrix[indexQuarterPart][indexLastPart].getExtension()); 
				//ringPointNet_1[RingDefinitionContainerID::kRelativePrimaryAxisID].setValue(Vx::VxVector3(1.0, 0.0, 0.0));		
			//}
			//else if (i==3)	
			//{
