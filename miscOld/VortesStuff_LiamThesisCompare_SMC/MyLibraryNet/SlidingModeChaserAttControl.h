...
VxVector3 SlidingModeChaserAttControl_ST(VxSmartInterface<Part>* chaserPartPtr, VxSmartInterface<Part> tetheredTargetPartPtr, VxVector3 C, VxVector3 K, VxVector3 desiredAngVel, double delta, FILE* outChaser);
