...
void addChaser(VxSmartInterface<Assembly> assembly, std::string pathData, VxSmartInterface<Part>* chaserPartPtr)
{
	...
	//box->parameterDimension = VxVector3(chaserSideLength,chaserSideLength,chaserSideLength);//original
	//box->parameterDimension = VxVector3(0.64, 0.96, 0.96);//AB Box, Case 1
	//box->parameterDimension = VxVector3(2.56, 0.32, 2.56);//AB Box, Case 2
	//box->parameterDimension = VxVector3(2.88, 0.32, 0.32);//AB Box, Case 3
	box->parameterDimension = VxVector3(1.28, 0.96, 0.96);//AB Box, Case 4
