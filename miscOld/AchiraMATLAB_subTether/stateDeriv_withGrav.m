function [ds] = stateDeriv_withGrav(t,s,massPoint1, targetM,targetI,chaserM, chaserI, chaserSideLength, targetSideLengthX, targetSideLengthY,targetSideLengthZ, Kvec, l0vec, cVec, mu)
...
%     Fthrust = [-500, 0, 0]';
    ...
    %with gravity
    gravChaser = - mu*chaserM*posChaser/(norm(posChaser)^3);
    accChaser = (Tvec_mt + Fthrust + gravChaser)/chaserM;
