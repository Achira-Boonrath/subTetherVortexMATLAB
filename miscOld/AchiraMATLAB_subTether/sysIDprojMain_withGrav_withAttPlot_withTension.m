...
Kvec = [10000.0, 10000.0/4.0, 10000.0/4.0, 10000.0/4.0, 10000.0/4.0];
...
pos0chaser = [-6176011.651346 	 -420791.887352 	 2973767.313130 ]'; 
vel0chaser = [-2457.764674 	 -4404.283389 	 -5712.420605]'; 

% q0chaser = [1 0 0 0]';

q0chaser = [0.556670 0.171010 0.469846 -0.663414]';
...
pos0target = [-6176021.746162 	 -420810.019237 	 2973743.781889]'; 
vel0target = [-2457.764674 	 -4404.283389 	 -5712.420605]'; 

% q0target = [1 0 0 0]';

q0target= [0.556670 0.171010 0.469846 -0.663414]';
omega0target = [0.0 0 0.0]'; 

states0_target = [pos0target; vel0target; q0target; omega0target]; 

%% connection point prop
% pos0connPoint1 = [15.6875 0 0]'; 
pos0connPoint1 = [-6176016.698754 	 -420800.953295 	 2973755.547509]'; 
% vel0connPoint1 = [0 0 0]'; 
vel0connPoint1 = [-2457.764674 	 -4404.283389 	 -5712.420605]'; 
...
muEarth = 3.986000e14;%gravitational parameter

tStart = tic; 
[t_mod_code2,s_mod_code2] = ode45(@(t,s) stateDeriv_withGrav(t,s,massPoint1, targetM,targetI,chaserM, chaserI, chaserSideLength, targetSideLengthX, targetSideLengthY,targetSideLengthZ, Kvec, l0vec, cVec, muEarth),tspan,s0,options);
