...
#ifndef ORBITALMECH2BPPART_H    // To make sure you don't declare the function more than once by including the header multiple times.
#define ORBITALMECH2BPPART_H
...
Vx::VxVector3 OrbitalMech2BP_Part(Vx::VxPart* part, VxReal mu);
