...
#ifndef ORBITALMECH2BPCOM_H    // To make sure you don't declare the function more than once by including the header multiple times.
#define ORBITALMECH2BPCOM_H
