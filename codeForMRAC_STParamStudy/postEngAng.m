function [chaserAngEng, debrisAngEng] = postEngAng(chaserInfo, targetInfo, NodeX, NodeY, NodeZ, NodeVX, NodeVY, NodeVZ, chaserSideLength, N_k, Kvec, l0vec, cVec, mu, FT, chaserI, targetI)
...
%% N2L Chaser
        chaserAngEng(i) = (omegaChaser')*chaserI*omegaChaser;
        debrisAngEng(i) = (omegaTarget')*targetI*omegaTarget;
