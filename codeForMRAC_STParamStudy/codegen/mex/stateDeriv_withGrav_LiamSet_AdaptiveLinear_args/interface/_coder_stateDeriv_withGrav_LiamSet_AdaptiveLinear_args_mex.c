 ...
 *
 * _coder_stateDeriv_withGrav_LiamSet_AdaptiveLinear_args_mex.c
 *
 * Code generation for function
 * '_coder_stateDeriv_withGrav_LiamSet_AdaptiveLinear_args_mex'
 *
 */
                 ...
                 const mxArray *prhs[])
{
  ...
  mexAtExit(&stateDeriv_withGrav_LiamSet_AdaptiveLinear_args_atexit);
  ...
  if (setjmp(emlrtJBEnviron) == 0) {
    stateDeriv_withGrav_LiamSet_AdaptiveLinear_args_mexFunction(nlhs, plhs,
                                                                nrhs, prhs);
...
void stateDeriv_withGrav_LiamSet_AdaptiveLinear_args_mexFunction(
    int32_T nlhs, mxArray *plhs[1], int32_T nrhs, const mxArray *prhs[3])
{
  ...
  if (nrhs != 3) {
    emlrtErrMsgIdAndTxt(&st, "EMLRT:runTime:WrongNumberOfInputs", 5, 12, 3, 4,
                        47, "stateDeriv_withGrav_LiamSet_AdaptiveLinear_args");
  }
  if (nlhs > 1) {
  ...
  /* Call the function. */
  c_stateDeriv_withGrav_LiamSet_A(prhs, &outputs);
