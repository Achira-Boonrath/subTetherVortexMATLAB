 ...
 *
 * _coder_stateDeriv_withGrav_LiamSet_MRAC1_args_api.c
 *
 * Code generation for function
 * '_coder_stateDeriv_withGrav_LiamSet_MRAC1_args_api'
 *
 */
                               ...
                               const emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  static const char_T *fieldNames[29] = {"L0",
                                         "kA",
                                         "gamma",
                                         "sigmaMRAC_h",
                                         "sigmaMRAC_a1",
  ...
  y->L0 = b_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 0, "L0")),
      &thisId);
  thisId.fIdentifier = "kA";
  y->kA = b_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 1, "kA")),
      &thisId);
  thisId.fIdentifier = "gamma";
  y->gamma = b_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 2, "gamma")),
      &thisId);
...
void c_stateDeriv_withGrav_LiamSet_M(const mxArray *const prhs[3],
                                     const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
  ...
  stateDeriv_withGrav_LiamSet_MRAC1_args(&st, t, *s, &args, *ds);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*ds);
}

/* End of code generation (_coder_stateDeriv_withGrav_LiamSet_MRAC1_args_api.c)
 */
