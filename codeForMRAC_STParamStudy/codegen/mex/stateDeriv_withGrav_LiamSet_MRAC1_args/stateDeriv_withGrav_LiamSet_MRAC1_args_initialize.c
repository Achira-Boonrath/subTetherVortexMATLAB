 ...
 *
 * stateDeriv_withGrav_LiamSet_MRAC1_args_initialize.c
 *
...
static void stateDeriv_withGrav_LiamSet_MRAC1_args_once(void);
...
void stateDeriv_withGrav_LiamSet_MRAC1_args_initialize(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    stateDeriv_withGrav_LiamSet_MRAC1_args_once();
  }
}

/* End of code generation (stateDeriv_withGrav_LiamSet_MRAC1_args_initialize.c)
 */
