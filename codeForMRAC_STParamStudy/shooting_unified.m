function F = shootingConstT_unified(lambda0, x0, argsStruct)
    ...
    if minE == 0
        ...
        [z, ~, x_tf, ~, ~, tDone] = integrateAndComputeTerminal_minT(z0, tf_minT, ...
            argsStruct.muEarth, argsStruct.Tmax, argsStruct.Isp, argsStruct.g0, argsStruct.epsilon, argsStruct.L0, ...
            argsStruct.at, argsStruct.et, argsStruct.it, argsStruct.Omega_t, argsStruct.omega_t, argsStruct.muVal);
        ...
        [x_tf, z] = solveODE_unify(z0, x0, argsStruct.xf, argsStruct.tf, ...
            argsStruct.muEarth, argsStruct.Tmax, argsStruct.Isp, argsStruct.g0, argsStruct.epsilon, argsStruct.L0);
    ...
    if argsStruct.FixedFinalPos == 0
        ...
        F = [x_tf(1:end-1) - argsStruct.xf];  % terminal error
    end
...
function [x_tf, z] = solveODE_unify(z0, x0, xf, tf, muEarth, Tmax, Isp, g0, epsilon, L0)
    options = odeset('RelTol',1e-9, 'AbsTol',1e-9, 'Stats', 'off');
