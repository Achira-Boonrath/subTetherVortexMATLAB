...
gaOptions = optimoptions('ga', 'Display', 'off', 'PlotFcn', {@gaplotbestf, @gaplotstopping}, ...
    'FunctionTolerance',1e-06,'ConstraintTolerance',1e-06);
[xopt1, fopt1, exitflagGA1, outputGA1] = ga(@objfunsm_qrs, 2, [], [], [],...
    [], LB, UB, @nonlcon, [], gaOptions, beta);
...
[xopt2, fopt2, exitflagGA2, outputGA2] = ga(@objfunsm_rbf, 2, [], [], [],...
    [], LB, UB, @nonlcon, [], gaOptions, x_in,rbf_coeff,rho);
...
[xopt3, fopt3, exitflagGA3, outputGA3] = ga(@objfunsm_ann, 2, [], [], [],...
    [], LB, UB, @nonlcon, [], gaOptions, ann);
