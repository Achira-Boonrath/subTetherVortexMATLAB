...
void addTetheredTarget(VxSmartInterface<Assembly> assembly, std::string pathData, VxSmartInterface<Part>* tetheredTargetPartPtr)
{
	...
	//box->parameterDimension = VxVector3(targetSideLengthY, targetSideLengthX, targetSideLengthZ); //AB, compare with MATLAB

	//box->parameterDimension = VxVector3(3.25, 3.25, 11.0); //AB, Replicate Zenit Capture
