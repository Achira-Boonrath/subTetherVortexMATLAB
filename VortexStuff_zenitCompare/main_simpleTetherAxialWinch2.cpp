...
int main(int argc, const char *argv[])
{
	...
	outTether = fopen("TetherDynamics20S.txt","w");
    ...
    try 
    {
        ...
        VxVector3 pos2 = VxVector3(0, winchRadius, -0.5);
		...
		winchPart->parameterMassPropertiesContainer.mass = 0.1;
		...
		segmentDefinition0[SegmentDefinitionContainerID::kMaxElongationPercentageID].setValue(20.0);
