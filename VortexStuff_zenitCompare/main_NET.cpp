	...
	try
	{
		...
		*/
		...
		/*	VxSmartInterface<IExtension> dynamicsCableExtension;
			...
			//solverPar->setConstraintStdSolverTolerance(0.0001);
			fprintf(outSolver, "The solver tolerance is %g \n", solverPar->getConstraintStdSolverTolerance());
			solverPar->setConstraintStdSolverTolerance(0.000000001);
			fprintf(outSolver, "The solver tolerance is %g \n", solverPar->getConstraintStdSolverTolerance());
			...
			//Vx::VxSolverParameters::setConstraintStdSolverTolerance(0.000000001);
